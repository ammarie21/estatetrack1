...
List<RentalTransactionModel> buildTransactionsFromBookings(
  ...
  return bookings
      .where((booking) => paidAmountForBooking(booking) > 0)
      .map((booking) {
    ...
    final remaining = relatedReturn != null && relatedReturn.totalRemaining > 0
    ...
    return RentalTransactionModel(
      ...
      transactionStatus: transactionStatusFor(paid: paid, total: total),
...
String transactionStatusFor({required double paid, required double total}) {
